...
public class PurchaseHistoryController {
    ...
    @GetMapping
    public  ResponseEntity<?> getAllPerchasesOfUser(@AuthenticationPrincipal UserPrincipal userPrincipal){

        return ResponseEntity.ok(purchaseHistoryService.findIPurchaseItemsOfUser(userPrincipal.getId()));
    }
